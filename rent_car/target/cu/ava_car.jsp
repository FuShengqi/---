                    ...
                    <div class="col-md-2"
                        ...
                        <div style="display: block">
                            <i class="fa fa-ravelry" aria-hidden="true">品牌:
                                <c:out value="${item.modelName}"/>
                            </i>
                        </div>

                        <div style="display: block">
                            <i class="fa fa-meetup" aria-hidden="true">车系:
                                <c:out value="${item.modelType}"/>
                            </i>
                        </div>
                        <div style="display: block">
                        ...
                        <div style="display: block">
                            <i class="fa fa-grav" aria-hidden="true">座位数:
                                <c:out value="${item.modelSeatNum}"/>
                            </i>
                        </div>
                        <div style="display: block">
                            <i class="fa fa-tachometer" aria-hidden="true">颜色:
                                <c:out value="${item.carColor}"/>
                            </i>
                        </div>
                        <a class="btn btn-info btn-sm" href="/Car/QueryByCarNo?carNo=<c:out value="${item.carNo}"/>">详情</a>
