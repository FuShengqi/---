            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="number" required="true" id="client-phone" name="customerTel" class="form-control"
            ...
            success: function (dataVal) {
                ...
                if (dataVal.RESULT_KEY == 1) {
                    elem.append(
                        ...
                        + '该手机号已被<strong>' + dataVal['customerName'] + '</strong>使用'
                        + '</div>'
                    )
                } else {
                    elem.append(
