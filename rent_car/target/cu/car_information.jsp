        ...
        <div class="row" >
            <div class="col-md-12">
                <h4 class="page-header">
                    <c:out value="${carInfo.modelName}"/>
                    /
                    <c:out value="${carInfo.modelFuelTank}"/>
                    <br/>
                    <span id="carNo"><c:out value="${carInfo.carNo}"/></span>
                </h4>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 20px">
            ...
            <div class="col-md-3">
                <i class="fa fa-meetup" aria-hidden="true">车系:
                    <c:out value="${carInfo.modelType}"/>
                </i>
            </div>
            <div class="col-md-3">
                <i class="fa fa-tachometer" aria-hidden="true">颜色:
                    <c:out value="${carInfo.carColor}"/>
                </i>
            </div>
            <div class="col-md-3">
                <i class="fa fa-calendar" aria-hidden="true">购买日期:
                    <c:out value="${carInfo.carPurchaseD}"/>
                </i>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <i class="fa fa-grav" aria-hidden="true">座位数:
                    <c:out value="${carInfo.modelSeatNum}"/>
                </i>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <i class="fa fa-tint" aria-hidden="true">燃油编号:
                    <c:out value="${carInfo.carFuelN}"/>
                </i>
            </div>
            <div class="col-md-3">
                <i class="fa fa-info" aria-hidden="true">发动机号:
                    <c:out value="${carInfo.carEngineN}"/>
                </i>
            </div>
        </div>
