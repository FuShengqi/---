                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2" >
                        <div class="input-group">
                            ...
                            <input type="date" required="required" name="carBuyDate" class="form-control"
                                   placeholder="必填"
                ...
                <div class="col-md-12" style="margin-top: 10px">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" required="required" name="carEngineNo" maxlength="18" class="form-control"
                                   placeholder="必填" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" required="required" name="carFrameNo" maxlength="18" class="form-control"
                                   placeholder="必填" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input type="text" required="required" name="carFuelNo" maxlength="18" class="form-control"
                                   placeholder="必填" aria-describedby="basic-addon1">
                        </div>
                    </div>
...
<script>
    $("#form-submit").click(function () {
        var data = $('#car-infor-form').serializeArray();
        var jsonData = {};
